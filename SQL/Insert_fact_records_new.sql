...
sales.sales_date_calendar_month = PECiT.cal_salesDate_month and sales.sales_date_day = PECiT.salesDate_day and 
...
ordr.order_date_calendar_month  = PECiT.cal_orderDate_month and ordr.order_date_day = PECiT.orderDate_day and 
...
insert into `dw-2205-team3_salesorders`.financial_control_analysis_fact (
SELECT customer_sk, products_sk, supplier_sk, checkout_detials_sk as checkout_details_sk, order_date_sk, sales_date_sk, 
cost_price, amt as amount, gross_profit, qty as quantity, shipping_time, null as shipping_cost, discounted, 'TPCE' as sale_type, invoice_id as invoice_id_DD from  
`dw-2205-team3_salesorders`.tpceinvoicetemporary as TPCiT,
`dw-2205-team3_salesorders`.customer_dim as c, `dw-2205-team3_salesorders`.products_dim as p, 
`dw-2205-team3_salesorders`.supplier_dim as s, `dw-2205-team3_salesorders`.sales_date_dim as sales,
`dw-2205-team3_salesorders`.order_date_dim as ordr, `dw-2205-team3_salesorders`.checkout_details_dim_junk as junk 
where c.customer_id = TPCiT.customer_id and c.customer_sourceflag = "TPCE" and 
p.product_id = TPCiT.product_id and p.Product_sourceflag = "TPCE" and
s.supplier_id = TPCiT.supplier_id and 
sales.sales_date_fiscal_year = TPCiT.fiscal_sales_date_year and sales.sales_date_fiscal_quarter = TPCiT.fiscal_sales_date_quarter and 
sales.sales_date_calendar_year = TPCiT.cal_sales_date_year and sales.sales_date_calendar_quarter = TPCiT.cal_sales_date_quarter and 
sales.sales_date_calendar_month = TPCiT.cal_sales_date_month and sales.sales_date_day = TPCiT.cal_sales_date_day and 
ordr.order_date_fiscal_year is null and ordr.order_date_fiscal_quarter is null and 
ordr.order_date_calendar_year is null and ordr.order_date_calendar_quarter is null and 
ordr.order_date_calendar_month is null and ordr.order_date_day is null and 
junk.order_method is null and junk.payment_method is null and junk.shipping_method is null
group by customer_sk, products_sk, supplier_sk, checkout_details_sk, order_date_sk, sales_date_sk
);